...
G.CFG = {
  ...
  CAM_LERP: 5.5,
  GROUND: 170,         // open ground-floor height under buildings (walkable street corridor)
};

// Ability unlock thresholds (holographic cat food). Double jump is available
// from the start so every rooftop is reachable; dash & wall-run are still earned.
G.UNLOCKS = { dash: 10, djump: 0, wallrun: 45 };
...
G.state = {
  ...
  abilities: { dash: false, djump: true, wallrun: false },
...
G.resetState = function () {
  G.state = {
    started: false, paused: false, modal: null, photoMode: false,
    discovered: {}, tpUnlocked: {}, flags: {},
    counts: { food: 0, chip: 0, mem: 0, art: 0, leg: 0, key: 0, photos: 0, credits: 0, shrine: 0, badges: 0 },
    abilities: { dash: false, djump: true, wallrun: false },
    upgrades: {}, style: { collar: "#ff2bd6", trail: false, trailColor: "#00f0ff", pawsteps: false, sparkle: false, afterimage: false, skin: "calico", filter: "" },
    stats: { dist: 0, jumps: 0, walljumps: 0, dashes: 0, zips: 0, maxCombo: 0, credEarned: 0, jobs: 0, wisps: 0, raceRuns: 0, golds: 0, perfectJobs: 0 },
    ach: {}, quests: {}, kittens: {},
    boardStreak: 0, courierShield: false,
    secrets: {}, mysteries: {}, hiddenRewards: {}, miniGames: {}, npcHelp: {}, setRewards: {}, cosmetics: {},
    shrine: { level: 0, decor: {} }, skills: {}, skillPoints: 0,
    buffT: 0, xp: 0, level: 1, completionPct: 0,
  };
};
